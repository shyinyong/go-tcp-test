...
type GameMsg struct {
	...
	Command string `protobuf:"bytes,1,opt,name=command,proto3" json:"command,omitempty"` // Add more fields as necessary
}
...
func (x *GameMsg) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
var file_proto_game_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x02, 0x70, 0x62, 0x22, 0x23, 0x0a, 0x07, 0x47, 0x61, 0x6d, 0x65, 0x4d, 0x73,
	0x67, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x42, 0x07, 0x5a, 0x05, 0x2f,
...
var file_proto_game_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_proto_game_proto_goTypes = []interface{}{
	(*GameMsg)(nil), // 0: pb.GameMsg
}
